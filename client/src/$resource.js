...
**********************************************/
    ...
    function CoordFreqs($resource) {
        ...
        var initiateReq = function(params) {
            params['inten'] = 1;
            params['lim'] = 5;
            return $resource(apiSpec, params, {
                'fetch': {
                    method: 'GET',
                    isArray: true,
                    cancellable: true,
    ...
    function MapCtrl(
        ...
        */
        ...
        mapCtrl.request = function(params) {
            var req = CoordFreqs.fetchBBox(params);
            
            CoordFreqs.standingReq = CoordFreqs
                .fetchBBox(params)
                .fetch(function(data) {
                    ...
                    mapCtrl.setData(angular.copy(data));
                });
        };
